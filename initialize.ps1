...
Write-Verbose "Replacing 'EventStores' with '$PackageName' in all files..."
Write-Verbose "Also replacing 'EventStores' with '$($PackageName.ToLower())' in all files..."
...
function ProcessFile {
    ...
    try {
        ...
        if ($content -match "EventStores") {
            $content = $content -replace "EventStores", $PackageName
            $hasChanges = $true
        }
        
        if ($content -match "EventStores") {
            $content = $content -replace "EventStores", $PackageName.ToLower()
            $hasChanges = $true
        }
...
Rename-ProjectItems -SearchPattern "EventStores" -Replacement $PackageName -ItemType Directory
Rename-ProjectItems -SearchPattern "EventStores" -Replacement $PackageName -ItemType File
Rename-ProjectItems -SearchPattern "EventStores" -Replacement $PackageName.ToLower() -ItemType Directory
Rename-ProjectItems -SearchPattern "EventStores" -Replacement $PackageName.ToLower() -ItemType File
...
Write-Output "Package name has been changed from 'EventStores' to '$PackageName'"
Write-Output "Lowercase 'EventStores' has been changed to '$($PackageName.ToLower())'" 